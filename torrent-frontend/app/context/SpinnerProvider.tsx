...
export const SpinnerProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <SpinnerContext.Provider value={{ showSpinner, hideSpinner, isVisible }}>
      {isVisible &&<Loader />}
      {children}
...
const Loader: React.FC = () => {
    ...
    <div className="fixed w-full h-full flex items-center justify-center">
      <div className="absolute w-full h-full bg-gray-400 opacity-50"></div>
...
// Custom hook to use the SpinnerContext
